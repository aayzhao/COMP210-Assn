...
public class JavaWarmUp {
    ...
    public static void printStats(String cat, ProductBatch[] list){
        ...
        System.out.printf("\tAverage Assembling Fee: %d.2f", Math.round(calcAvgFee(cat, list)*100.0)/100.0);
        System.out.printf("\tAverage Net Profit: %d.2f", Math.round(calcNetProfit(cat, list)*100.0)/100.0);
    }
